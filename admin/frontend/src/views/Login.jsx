    ...
    <div className="min-h-screen flex flex-col items-center justify-center p-4 relative overflow-hidden bg-black">
      <div className="absolute inset-0">
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(to bottom, #000000 0%, #0a0010 20%, #150020 40%, #1a0a2e 55%, #2d1040 70%, #3d1045 85%, #1a0a15 100%)",
          }}
        />
        ...
        <div
          ...
          style={{
            background:
              "radial-gradient(ellipse 70% 50% at 50% 100%, rgba(255, 0, 128, 0.7) 0%, rgba(200, 0, 100, 0.5) 15%, rgba(150, 0, 80, 0.35) 30%, rgba(80, 0, 60, 0.2) 50%, transparent 70%)",
            pointerEvents: "none",
          }}
        />
        ...
        <div
          ...
          style={{
            background:
              "radial-gradient(ellipse 40% 45% at 70% 95%, rgba(200, 60, 20, 0.5) 0%, rgba(160, 40, 10, 0.3) 25%, rgba(100, 20, 5, 0.15) 50%, transparent 70%)",
            pointerEvents: "none",
          }}
        />
        ...
        <div
          ...
          style={{
            background:
              "radial-gradient(ellipse 35% 40% at 25% 98%, rgba(200, 100, 20, 0.3) 0%, rgba(150, 50, 10, 0.15) 30%, transparent 60%)",
            pointerEvents: "none",
          }}
        />
        ...
        <div
          ...
          style={{
            background:
              "radial-gradient(ellipse 30% 20% at 50% 105%, rgba(255, 100, 200, 0.8) 0%, rgba(255, 50, 150, 0.4) 30%, transparent 60%)",
            pointerEvents: "none",
          }}
        />
        ...
        <div
          ...
          style={{
            ...
            height: "3%",
            background:
              "radial-gradient(ellipse 60% 100% at 50% 100%, rgba(255, 180, 100, 0.3) 0%, transparent 70%)",
            pointerEvents: "none",
          }}
        />
        <DeepSpaceBackground />
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <Card
          className="bg-slate-900/92 backdrop-blur-xl border-none shadow-2xl"
          style={{
            boxShadow:
              "0 8px 40px rgba(0,0,0,0.7), inset 0 1px 0 rgba(255,255,255,0.08)",
          }}
        >
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <Input
                    ...
                    className="h-11 bg-slate-800/50 border-none pr-11 focus:ring-2 focus:ring-cyan-500/20 text-slate-100 placeholder:text-slate-500 transition-all"
                  />
                  <button
                    type="button"
